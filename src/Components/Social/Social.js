...
export default function Social() {
  return (
    <div className="social">
        ...
        <li><a target="_blank" href="https://www.facebook.com/" className="icoFacebook" title="Facebook"><i className="fa fa-facebook"></i></a></li>
        ...
        <li><a target="_blank" href="https://www.youtube.com/" className="icoYoutube" title="Youtube"><i className="fa fa-youtube-play"></i></a></li>
